...
const Hero: React.FC<HeroProps> = ({
  ...
  return <section className="min-h-screen bg-black text-white flex flex-col items-center py-0 px-0">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <button onClick={onWhatsAppClick} className="bg-[#e4257e] hover:bg-[#e4257e]/90 text-white font-bold py-4 px-8 rounded-full text-lg flex items-center justify-center gap-2 mx-auto" aria-label="Reservar agora pelo WhatsApp">
