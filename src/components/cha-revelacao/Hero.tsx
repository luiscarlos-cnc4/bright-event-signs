      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-8 mx-auto max-w-md">
          <div className="aspect-video relative rounded-lg overflow-hidden">
            <img src="/lovable-uploads/3fa7bc2b-9a33-4f51-b430-30e809ef94af.png" alt="Casal se abraçando em chá revelação com fumaça rosa e letreiro BABY" className="w-full h-full object-cover alt-[decoracao-cha-revelacao-em-piracicaba]\\n" />
          </div>
        </div>
        
        <button onClick={onWhatsAppClick} aria-label="Reservar agora pelo WhatsApp" className="bg-[#e4257e] hover:bg-[#e4257e]/90 text-white font-bold py-4 px-8 rounded-full text-lg flex items-center justify-center gap-2 mx-auto mb-0 !mb-0\n">
