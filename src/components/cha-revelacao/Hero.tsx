...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <section className="pt-16 md:pt-20 pb-8 md:pb-12 px-4 bg-vegas-black">
      <div className="max-w-4xl mx-auto text-center">
        <img 
          src="/lovable-uploads/e119c6d9-e014-4421-a7b0-c842dcccb14f.png" 
          alt="Vegas Letras" 
          className="mx-auto h-12 md:h-16 mb-8" 
        />
        ...
        <button 
          ...
          className="bg-[#e4257e] hover:bg-[#e4257e]/90 text-white font-bold py-3 px-8 rounded-full text-lg flex items-center justify-center gap-2 mx-auto"
