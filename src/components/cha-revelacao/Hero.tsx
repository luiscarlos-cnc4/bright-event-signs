...
const Hero: React.FC<HeroProps> = ({ onWhatsAppClick }) => {
  return (
    <section className="pt-16 md:pt-20 pb-8 md:pb-12 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <img 
          ...
          alt="Vegas Letras" 
          className="mx-auto h-12 md:h-15 mb-4" 
        />
        
        <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-4 text-white leading-tight">
