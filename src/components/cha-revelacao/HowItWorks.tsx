      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mt-16">
          <a
            ...
            className="bg-[#FF00FF] hover:bg-[#FF00FF]/80 text-white font-bold py-4 px-8 rounded-full text-lg flex items-center justify-center gap-2 mx-auto inline-flex w-auto"
          >
